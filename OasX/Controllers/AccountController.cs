...
namespace OasX.Controllers
{
    ...
    {
        private OasXUserManager _userManager;
        private OasXRoleManager _roleManager;
        private IManagementService _managementService;

        public AccountController(OasXUserManager userManager, OasXRoleManager roleManager, IManagementService managementService) {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model) {
            if (ModelState.IsValid) {
                var user = new OasXIdentityUser {UserName = model.UserName};
        ...
        private void CreateStudent(OasXIdentityUser user) {
            var student = new Student {MemberId = new Guid(user.Id)};
            _managementService.CreateStudent(student);
        }

        private async Task SignInAsync(OasXIdentityUser user, bool isPersistent) {
